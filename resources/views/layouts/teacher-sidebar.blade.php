<!-- Navegación Global HTML Estático para Docente -->
...
<div class="sidebar">
    ...
    <div class="user-profile">
        <img src="https://ui-avatars.com/api/?name=Maria+Gonzalez+Lopez&background=3498db&color=fff" alt="Perfil">
        <div class="user-info">
            <h5>María González López</h5>
            <p>Docente</p>
        </div>
    </div>
    ...
    <ul class="list-unstyled components">
        <li class="active">
            <a href="/panel/docente"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a>
        </li>
        <li>
            <a href="/reportes/incidentes"><i class="fas fa-exclamation-triangle me-2"></i> Ver Incidentes</a>
        </li>
        <li>
            <a href="/reportes/formulario"><i class="fas fa-plus me-2"></i> Reportar Incidente</a>
        </li>
        <li>
