...
<head>
    ...
    <title>Objetos Perdidos - Estudiante</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-box-open me-2"></i> Mis Objetos Perdidos</h2>
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="stats-card">
                        <h3><?= $estadisticas['total_objetos'] ?></h3>
                        <p>Total Objetos</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <h3><?= $estadisticas['objetos_perdidos'] ?></h3>
                        <p>Perdidos</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <h3><?= $estadisticas['objetos_encontrados'] ?></h3>
                        <p>Encontrados</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <h3><?= $estadisticas['objetos_devueltos'] ?></h3>
                        <p>Devueltos</p>
                    </div>
                </div>
            </div>
                ...
                <?php if (empty($objetos)): ?>
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            ...
                            <h4>No tienes objetos reportados</h4>
                            <p>Cuando reportes un objeto perdido, aparecerá aquí.</p>
                            <a href="<?php echo route('objetos.estudiante.reportar'); ?>" class="btn btn-primary">
                                <i class="fas fa-plus me-2"></i> Reportar mi primer objeto
                            </a>
                        </div>
                    </div>
                <?php else: ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted">
                                            Reportado: <?= date('d/m/Y', strtotime($objeto['fecha_reporte'])) ?>
                                        </small>
