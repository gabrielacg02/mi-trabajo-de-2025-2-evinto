...
<head>
    ...
    <title>Reportar Objeto Perdido - Seguridad Universitaria</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="active">
                <a href="<?php echo route('objetos.estudiante.reportar'); ?>"><i class="fas fa-box-open me-2"></i> Objetos Perdidos</a>
            </li>
            <li>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-box-open me-2"></i> Reportar Objeto Perdido</h2>
                <a href="<?php echo route('objetos.estudiante'); ?>" class="btn btn-outline-primary">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5><i class="fas fa-info-circle me-2"></i> Información del Objeto</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="tipo_objeto" name="tipo_objeto" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ubicacion" name="ubicacion" 
                                           placeholder="Ej: Edificio A, Aula 101, Cafetería" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="descripcion" class="form-label">Descripción del Objeto *</label>
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="4" 
                                              placeholder="Describe detalladamente el objeto perdido: color, marca, características distintivas..." required></textarea>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="evidencias" class="form-label">Subir Fotos</label>
                                    <input type="file" class="form-control" id="evidencias" name="evidencias[]" multiple 
                                           accept="image/*">
                                    <div class="form-text">Puedes subir hasta 5 imágenes del objeto perdido.</div>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="observaciones" class="form-label">Observaciones Adicionales</label>
                                    <textarea class="form-control" id="observaciones" name="observaciones" rows="3" 
                                              placeholder="Cualquier información adicional que pueda ayudar a identificar el objeto..."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5><i class="fas fa-info-circle me-2"></i> Estado del Reporte</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            const tipoObjeto = document.getElementById('tipo_objeto').value;
            const fechaEvento = document.getElementById('fecha_evento').value;
            const ubicacion = document.getElementById('ubicacion').value;
            const descripcion = document.getElementById('descripcion').value;
            
            if (!tipoObjeto || !fechaEvento || !ubicacion || !descripcion) {
                e.preventDefault();
            ...
            const fechaEvent = new Date(fechaEvento);
